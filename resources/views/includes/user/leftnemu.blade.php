<div class="mdk-drawer  js-mdk-drawer" id="default-drawer" data-align="">
    <div class="mdk-drawer__content">
        <div class="sidebar sidebar-dark sidebar-left bg-primary-darker" data-perfect-scrollbar>


            <a href="index.html" class="sidebar-block flex items-center text-xl pt-4 text-white">
                        ...
                        <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g id="Profile-Photo" transform="translate(-67.000000, -117.000000)">
                                <path
                                    ...
                                    id="Path" fill="rgba(0,0,0,.12)"></path>
                                <path
                                    ...
                                    id="Path-Copy-2" fill="rgba(0,0,0,.12)"></path>
                                <path
                                    ...
                                    id="Path-Copy" stroke="rgba(0,0,0,.12)" stroke-width="6" fill="#FFFFFF"></path>
                            </g>
                        </g>
                    </svg>
            ...
            <div class="sidebar-block flex justify-between mt-4">
                <!-- This is an example component -->
                <div class="relative text-white hidden lg:flex flex-grow ">
                    <input type="search" name="search" placeholder="Search" class="bg-darker pr-8 focus:bg-darker">
            ...
            <ul class="sidebar-menu" id="demos_menu">
                ...
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button" href="admin-third.html">
                        <span class="sidebar-menu-icon sidebar-menu-icon--left">
                            <svg class="w-6 h-6 -mt-1" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                ...
                <!-- <li class="sidebar-menu-item">
      <a class="sidebar-menu-button" href="admin-mini.html">
        <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">dvr</i>
        <span class="sidebar-menu-text">Mini</span>
      </a>
    </li> -->
                <li class="sidebar-menu-item">
                    <a class="sidebar-menu-button" href="admin-fifth.html">
                        <span class="sidebar-menu-icon sidebar-menu-icon--left">
                            <i class="material-icons">business</i>
                        </span>
                        <span class="sidebar-menu-text">CRM</span>
            ...
            <div class="sidebar-block">
                ...
                <div class="leading-none border-t border-b pt-4 pb-4 text-sm">
                    <div class="mb-2">
                        <a href="#" class="text-body"><strong>Marketing Team Meeting</strong></a>
                        <div><small class="text-muted w-1/2">2 hrs ago</small></div>
                    </div>
                    <div class="flex overflow-hidden mt-2 ">
                        <img class="inline-block h-6 w-6 rounded-full text-white"
                            src="https://images.unsplash.com/photo-1491528323818-fdd1faba62cc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
                            alt="">
                        <img class="-ml-1 inline-block h-6 w-6 rounded-full text-white"
                ...
                <div class="leading-none border-t border-b pt-4 pb-4 text-sm">
                    <div class="mb-2">
                        <a href="#" class="text-body"><strong>Automatic Notification</strong></a>
                        <div><small class="text-muted w-1/2">1 day ago</small></div>
                    </div>
                    <div class="flex items-center"><i class="material-icons mr-1" style="font-size: 14px;">email</i>
                        <div> Sent an <a href="#" class="text-white">Email</a> to Adrian </div>
                    </div>
                </div>
                ...
                <div class="leading-none border-t border-b pt-4 pb-4 text-sm">
                    <div class="mb-2">
                        <a href="#" class="text-body"><strong>Event Scheduled</strong></a>
                        <div><small class="text-muted w-1/2">2 days ago</small></div>
                    </div>

                    <div class="flex items-center"><i class="material-icons mr-1"
                            style="font-size:14px;">location_on</i> Miami Street, Florida, USA</div>
