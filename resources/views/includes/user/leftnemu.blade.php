<div id="sidebar"
    class="h-screen w-16 menu bg-gray-900 text-gray-200 px-4 flex items-center nunito static fixed shadow">

    <ul class="list-reset ">
        <li class="my-2 md:my-0">
            <a href="{{route('home')}}"
                class="block py-1 md:py-3 pl-1 align-middle text-gray-400 no-underline hover:text-purple-600 ">
                <i class="fas fa-home fa-fw mr-3"></i><span class="w-full inline-block pb-1 md:pb-0 text-sm">Home</span>
            </a>
        </li>
        <li class="my-2 md:my-0 ">
            <a href="#" class="block py-1 md:py-3 pl-1 align-middle text-gray-400 no-underline hover:text-purple-600 ">
        ...
        <li class="my-2 md:my-0">
            <a href="#" class="block py-1 md:py-3 pl-1 align-middle text-gray-400 no-underline hover:text-purple-600 ">
                <i class="fas fa-chart-area fa-fw mr-3 text-gray-400 "></i><span
