<div class="h-40 lg:h-20 w-full flex flex-wrap">
    ...
    <nav id="header1" class="bg-gray-900 w-auto flex-1 border-b-1 border-gray-500 order-1 lg:order-2">
            ...
            <div class="flex relative inline-block pr-6">
                ...
                <div class="relative text-sm">
                    ...
                    <div id="userMenu"
                        ...
                        <ul class="list-reset">
                            <li><a href="#"
                                    class="px-4 py-2 block text-gray-900 hover:bg-purple-600  hover:text-white no-underline hover:no-underline">My
                                    account</a></li>
                            <li><a href="#"
                                    class="px-4 py-2 block text-gray-900 hover:bg-purple-600  hover:text-white no-underline hover:no-underline">Notifications</a>
                            </li>
                            <li>
                                <hr class="border-t mx-2 border-gray-400">
                            </li>
                            <li><a href="#"
                                    class="px-4 py-2 block text-gray-900 hover:bg-purple-600  hover:text-white no-underline hover:no-underline">Logout</a>
                            </li>
                        </ul>
                    </div>
                </div>
