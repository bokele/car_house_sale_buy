            ...
            <div class="container mx-auto px-4">
                    ...
                    <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
                        <div
                            ...
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <h6 class="text-xl font-semibold">Buy </h6>
                                <p class="mt-2 mb-4 text-gray-600">
                                    Here you can negosetate the price of all item, chnat with us direct
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="w-full md:w-4/12 px-4 text-center">
                        <div
                            ...
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <h6 class="text-xl font-semibold">Sale</h6>
                                <p class="mt-2 mb-4 text-gray-600">
                                    Sale your car, house, plot.
                    ...
                    <div class="pt-6 w-full md:w-4/12 px-4 text-center">
                        <div
                            ...
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <h6 class="text-xl font-semibold">Rent</h6>
                                <p class="mt-2 mb-4 text-gray-600">
                                    Rend your Car and House.
                                    All you can do is to have account, upload information and reach people out your arr
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-wrap items-center mt-32">
                    <div class="w-full md:w-5/12 px-4 mr-auto ml-auto">
                        ...
                        <h3 class="text-3xl mb-2 font-semibold leading-normal text-gray-300">
                            Saling your Can, House and Plot
                        </h3>
                        <p class="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-300">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat neque suscipit velit odit
                            eos sint veritatis at repudiandae atque aut ullam modi, laudantium tempora,
                        </p>
                        <p class="text-lg font-light leading-relaxed mt-0 mb-4 text-gray-300">
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Rem sint sunt ad, dicta molestias
                            suscipit vel recusandae animi debitis nam, rerum vitae maiores doloribus. Iusto magnam eius
                            itaque accusantium facilis.
                        </p>
                        <a href="https://www.creative-tim.com/learning-lab/tailwind-starter-kit#/presentation"
                            class="text-blue-500 background-transparent font-bold uppercase px-8 py-3 outline-none focus:outline-none mr-1 mb-1">
                            Start Now</a>
                    </div>
                ...
                <div class="items-center flex flex-wrap">
                    ...
                    <div class="w-full md:w-5/12 ml-auto mr-auto px-4">
                        <div class="md:pr-12">
                            ...
                            <h3 class="text-3xl font-semibold">Rent your Car and House</h3>
